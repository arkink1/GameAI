...
class Minesweeper():
    ...
    def __init__(self, height=8, width=8, mines=8):
        ...
        # At first, player has found no minesw
...
class MinesweeperAI():
    ...
    def add_knowledge(self, cell, count):
        ...
        for i in self.knowledge:
            if i != sentence:
                if len(i.cells) > 0 and i.cells.issubset(sentence.cells):
                    nset = sentence.cells - i.cells
                    ncount = abs(sentence.count - i.count)
                    sentences.append(Sentence(nset, ncount))
                elif len(sentence.cells) > 0 and sentence.cells.issubset(i.cells):
                    nset = i.cells - sentence.cells
                    ncount = abs(i.count - sentence.count)
                    sentences.append(Sentence(nset, ncount))
